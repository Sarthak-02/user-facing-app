        ...
        {announcements.map((item) => {
          ...
          return (
            <div
              ...
              className="bg-white rounded-xl border border-gray-200 border-l-4 border-l-violet-400 cursor-pointer hover:shadow-md hover:-translate-y-0.5 transition-all duration-200 overflow-hidden"
            >
              <div className="p-4 pb-3">
                <div className="flex items-start gap-3">
                  <div className="flex-shrink-0 w-9 h-9 rounded-full bg-violet-100 flex items-center justify-center">
                    <span className="text-sm font-bold text-violet-700">{senderInitial(item)}</span>
                  </div>
              ...
              <div className="px-4 py-2.5 bg-violet-50 border-t border-gray-100 flex items-center justify-between">
